...
public final class CommandUtils {
    ...
    public static void waypointClicked(String command) {
        boolean control = InputConstants.isKeyDown(InputConstants.getKey("key.keyboard.left.control").getValue())
                || InputConstants.isKeyDown(InputConstants.getKey("key.keyboard.right.control").getValue());
