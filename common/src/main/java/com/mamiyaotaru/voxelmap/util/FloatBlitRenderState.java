...
public record FloatBlitRenderState(
    ...
    public FloatBlitRenderState(
            ...
            this(renderPipeline, textureSetup, matrix3x2f, x0, y0, x1, y1, u0, u1, v0, v1, color, color2, forcedDepth, screenRectangle, getBounds(x0, y0, x1, y1, matrix3x2f, screenRectangle));
        }
