...
public enum EnumMobs {
    ...
    COW(Cow.class, "Cow", true, 0.0F, "textures/entity/cow/temperate_cow.png", "", false, true),
    ...
    PIG(Pig.class, "Pig", true, 0.0F, "textures/entity/pig/temperate_pig.png", "", false, true),
