...
public class VoxelMapGuiGraphics {
    ...
    // TODO: 1.20.1 Port - Replace with proper 1.20.1 rendering type
    public static void blitFloatGradient(GuiGraphics graphics, Object pipeline, Identifier texture, float x, float y, float w, float h, float minu, float maxu, float minv, float maxv, int color, int color2) {
    ...
    // TODO: 1.20.1 Port - Replace with proper 1.20.1 rendering type
    public static void blitFloat(GuiGraphics graphics, Object pipeline, Identifier texture, float x, float y, float w, float h, float minu, float maxu, float minv, float maxv, int color) {
