...
public class GuiMinimapControls extends GuiScreenMinimap {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.centeredText(getFont(), I18n.get("controls.minimap.unbind1"), getWidth() / 2, getHeight() - 62, 0xFFFFFFFF);
        graphics.centeredText(getFont(), "§e" + I18n.get("controls.minimap.unbind2"), getWidth() / 2, getHeight() - 46, 0xFFFFFFFF);
    }
    ...
    class KeyList extends GuiListMinimap<KeyList.Entry> {
        ...
        public class Entry extends GuiListMinimap.Entry<Entry> {
            ...
            public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float tickDelta) {
                ...
                graphics.text(parentGui.getFont(), Component.translatable(keyMapping.getName()), getX() + 5, getY() + 5, 0xFFFFFFFF);
