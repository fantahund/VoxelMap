    ...
    private static SettingsCategory waypoints(MapSettingsManager map) {
        return new SettingsCategory("waypoints", "options.voxelmap.category.waypoints", List.of(
                group("options.voxelmap.group.waypointDisplay",
                        ...
                        choice("waypoints.layout", "test_sign_layout", map, () -> map.waypointSignLayout,
                                value -> map.waypointSignLayout = value, value(0, "options.off"),
                                value(1, "test_default"), value(2, "test_classic_top"), value(2, "test_classic_bottom")),
                        toggle("waypoints.highlight", "test_highlight_sign_on_focus", map, () -> map.highlightSignOnFocus, value -> map.highlightSignOnFocus = value),
