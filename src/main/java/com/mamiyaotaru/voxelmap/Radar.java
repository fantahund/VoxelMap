...
public class Radar implements IRadar {
   ...
   private String[] armorNames = new String[]{
      "cloth", "clothOverlay", "clothOuter", "clothOverlayOuter", "chain", "iron", "gold", "diamond", "netherite", "turtle"
   };
   ...
   private void loadTexturePackIcons() {
      ...
      try {
         ...
         if (ReflectionUtils.classExists("com.prupe.mcpatcher.mob.MobOverlay")
            && ImageUtils.loadImage(new Identifier("mcpatcher/mob/cow/mooshroom_overlay.png"), 0, 0, 1, 1) != null) {
         ...
         for(int t = 0; t < EnumMobs.values().length - 1; ++t) {
            ...
            if (mobImage != null) {
               ...
               if ((double)EnumMobs.values()[t].expectedWidth > 0.5) {
                  mobImage = this.createImageFromTypeAndResourceLocations(
                     EnumMobs.values()[t], EnumMobs.values()[t].resourceLocation, EnumMobs.values()[t].secondaryResourceLocation, (Entity)null
                  );
                  if (mobImage != null) {
         ...
         BufferedImage[] armorImages = new BufferedImage[]{
            ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1.png"), 8, 8, 8, 8),
            ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1.png"), 40, 8, 8, 8),
            ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1_overlay.png"), 8, 8, 8, 8),
            ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1_overlay.png"), 40, 8, 8, 8)
         };

         for(int t = 0; t < armorImages.length; ++t) {
            float scale = (float)armorImages[t].getWidth() / 8.0F;
            armorImages[t] = ImageUtils.fillOutline(
               ImageUtils.pad(ImageUtils.scaleImage(armorImages[t], 4.0F / scale * 47.0F / 38.0F)),
               this.options.outlines && t != 2 && t != 3,
               true,
               37.6F,
               37.6F,
               2
         ...
         zombie = ImageUtils.addImages(
            ImageUtils.addImages(
               new BufferedImage(zombieHat.getWidth(), zombieHat.getHeight() + 8, 6),
               zombie,
               (float)(zombieHat.getWidth() - zombie.getWidth()) / 2.0F,
               (float)(zombieHat.getHeight() - zombie.getHeight()) / 2.0F,
               zombieHat.getWidth(),
               zombieHat.getHeight() + 8
            ),
            zombieHat,
            0.0F,
            0.0F,
         ...
         skeleton = ImageUtils.addImages(
            new BufferedImage(skeleton.getWidth(), skeleton.getHeight() + 8, 6), skeleton, 0.0F, 0.0F, skeleton.getWidth(), skeleton.getHeight() + 8
         );
         skeleton = ImageUtils.fillOutline(ImageUtils.pad(skeleton), this.options.outlines, true, 37.6F, 37.6F, 2);
         this.textureAtlas
            .registerIconForBufferedImage("minecraft." + EnumMobs.SKELETON.id + EnumMobs.SKELETON.resourceLocation.toString() + "head", skeleton);
         ...
         witherSkeleton = ImageUtils.addImages(
            new BufferedImage(witherSkeleton.getWidth(), witherSkeleton.getHeight() + 8, 6),
            witherSkeleton,
            0.0F,
            0.0F,
            witherSkeleton.getWidth(),
            witherSkeleton.getHeight() + 8
         );
         witherSkeleton = ImageUtils.fillOutline(ImageUtils.pad(witherSkeleton), this.options.outlines, true, 37.6F, 37.6F, 2);
         this.textureAtlas
            .registerIconForBufferedImage(
               "minecraft." + EnumMobs.SKELETONWITHER.id + EnumMobs.SKELETONWITHER.resourceLocation.toString() + "head", witherSkeleton
            );
         BufferedImage creeper = ImageUtils.addImages(
            ImageUtils.blankImage(EnumMobs.CREEPER.resourceLocation, 8, 10),
            ImageUtils.loadImage(EnumMobs.CREEPER.resourceLocation, 8, 8, 8, 8),
            0.0F,
            0.0F,
            8,
            10
         ...
         creeper = ImageUtils.fillOutline(
            ImageUtils.pad(ImageUtils.scaleImage(creeper, 4.0F / scale * 47.0F / 38.0F)), this.options.outlines, true, 37.6F, 37.6F, 2
         );
         ...
         BufferedImage dragon = this.createImageFromTypeAndResourceLocations(
            EnumMobs.ENDERDRAGON, EnumMobs.ENDERDRAGON.resourceLocation, (Identifier)null, (Entity)null
         );
         ...
         this.textureAtlas
            .registerIconForBufferedImage("minecraft." + EnumMobs.ENDERDRAGON.id + EnumMobs.ENDERDRAGON.resourceLocation.toString() + "head", dragon);
         ...
         sheepFur = ImageUtils.eraseArea(
            sheepFur, chop, chop, sheepFur.getWidth() - chop * 2, sheepFur.getHeight() - chop * 2, sheepFur.getWidth(), sheepFur.getHeight()
         );
   ...
   private BufferedImage createImageFromTypeAndResourceLocations(
      EnumMobs type, Identifier resourceLocation, Identifier resourceLocationSecondary, Entity entity
   ) {
   ...
   private BufferedImage createImageFromTypeAndImages(EnumMobs type, BufferedImage mobImage, BufferedImage mobImageSecondary, Entity entity) {
      ...
      case PARROT:
         image = ImageUtils.addImages(
            ImageUtils.addImages(
               ImageUtils.addImages(
                  ImageUtils.addImages(
                     ImageUtils.addImages(ImageUtils.blankImage(mobImage, 8, 8, 32, 32), ImageUtils.loadImage(mobImage, 2, 22, 3, 5, 32, 32), 1.0F, 0.0F, 8, 8),
      ...
      case PHANTOM:
         image = ImageUtils.addImages(
            ImageUtils.loadImage(mobImage, 5, 5, 7, 3, 64, 64), ImageUtils.loadImage(mobImageSecondary, 5, 5, 7, 3, 64, 64), 0.0F, 0.0F, 7, 3
         );
         break;
      case PUFFERFISH:
         image = ImageUtils.addImages(
               ...
               if (hypot < 961.0) {
                  ...
                  if (enabled) {
                     ...
                     if (scrubbedName != null
                        ...
                        && (!(contact.entity instanceof PlayerEntity) || ((PlayerEntity)contact.entity).isPartVisible(PlayerModelPart.CAPE))) {
   ...
   private void tryAutoIcon(Contact contact) {
         ...
         if (contact.type == EnumMobs.MOOSHROOM) {
            ...
            label166: {
               ...
               if (contact.type != EnumMobs.VILLAGER && contact.type != EnumMobs.ZOMBIEVILLAGER) {
                  ...
                  resourceLocationSecondary = new Identifier(
                     resourceLocationSecondary.getNamespace(),
                     "textures/entity/" + zombie + "villager/type/" + resourceLocationSecondary.getPath() + ".png"
                  );
                  if (villagerProfession != VillagerProfession.NONE && !((LivingEntity)contact.entity).isBaby()) {
                     ...
                     resourceLocationTertiary = new Identifier(
                        resourceLocationTertiary.getNamespace(),
                        "textures/entity/" + zombie + "villager/profession/" + resourceLocationTertiary.getPath() + ".png"
                     );
                     if (villagerProfession != VillagerProfession.NITWIT) {
                        resourceLocationQuaternary = (Identifier)LEVEL_TO_ID.get(MathHelper.clamp(villagerData.getLevel(), 1, LEVEL_TO_ID.size()));
                        resourceLocationQuaternary = new Identifier(
                           resourceLocationQuaternary.getNamespace(),
                           "textures/entity/" + zombie + "villager/profession_level/" + resourceLocationQuaternary.getPath() + ".png"
                        );
                     }
                  }
                  ...
                  boolean showBiomeHat = professionHatType == VillagerResourceMetadata.HatType.NONE
                     || professionHatType == VillagerResourceMetadata.HatType.PARTIAL && biomeHatType != VillagerResourceMetadata.HatType.FULL;
                  if (!showBiomeHat) {
                     resourceLocationSecondary = null;
                  }
               }
      ...
      resourceLocationString = resourceLocationString
         + (resourceLocationTertiary != null ? resourceLocationTertiary.toString() : "")
         + (resourceLocationQuaternary != null ? resourceLocationQuaternary.toString() : "");
      ...
      if (icon == this.textureAtlas.getMissingImage()) {
         ...
         if (contact.type == EnumMobs.HORSE) {
            ...
            if (resourceLocationSecondary != null) {
               ...
               pattern = ImageUtils.scaleImage(
                  pattern, (float)base.getWidth() / (float)pattern.getWidth(), (float)base.getHeight() / (float)pattern.getHeight()
               );
         ...
         if (mobImage != null) {
            ...
            mobImage = this.createAutoIconImageFromResourceLocations(
               contact, render, resourceLocation, resourceLocationSecondary, resourceLocationTertiary, resourceLocationQuaternary
            );
         }
      ...
      if (render instanceof LivingEntityRenderer) {
         try {
            ...
            if (headBits == null) {
               if (model instanceof PlayerEntityModel) {
                  ...
                  headBits = new ModelPart[]{
                     ((ModelPart)ReflectionUtils.getPrivateFieldValueByType(model, BeeEntityModel.class, ModelPart.class, 0)).getChild("body")
                  };
                  ...
                  headBits = new ModelPart[]{
                     endermiteEntityModel.getPart().getChild("segment0"), endermiteEntityModel.getPart().getChild("segment1")
                  };
                  ...
                  headBits = new ModelPart[]{
                     (ModelPart)ReflectionUtils.getPrivateFieldValueByType(model, RabbitEntityModel.class, ModelPart.class, 7),
                     (ModelPart)ReflectionUtils.getPrivateFieldValueByType(model, RabbitEntityModel.class, ModelPart.class, 8),
                     (ModelPart)ReflectionUtils.getPrivateFieldValueByType(model, RabbitEntityModel.class, ModelPart.class, 9),
                     (ModelPart)ReflectionUtils.getPrivateFieldValueByType(model, RabbitEntityModel.class, ModelPart.class, 11)
                  };
                  ...
                  headBits = new ModelPart[]{
                     silverFishEntityModel.getPart().getChild("segment0"), silverFishEntityModel.getPart().getChild("segment1")
                  };
            ...
            if (contact.entity != null
               && model != null
               && (headBits != null && headBits.length > 0 || headPartsWithResourceLocationList.size() > 0)
               && resourceLocations[0] != null) {
               ...
               ModelPartWithResourceLocation[] headBitsWithLocations = (ModelPartWithResourceLocation[])headPartsWithResourceLocationList.toArray(
                  new ModelPartWithResourceLocation[headPartsWithResourceLocationList.size()]
               );
   ...
   private boolean drawModel(
      float scale, int captureDepth, LivingEntity livingEntity, Direction facing, Model model, ModelPartWithResourceLocation[] headBits
   ) {
      ...
      try {
         if (this.randomobsOptifine) {
            ...
            if (randomEntitiesProperties != null) {
               ...
               resourceLocation = (Identifier)this.getEntityTextureMethod
      ...
      if (contact.type == EnumMobs.SHEEP) {
         ...
         if (helmet == Items.SKELETON_SKULL) {
               ...
               if (nbttagcompound.contains("SkullOwner", 10)) {
                  ...
                  if (name != null && !name.equals("")) {
                     ...
                     SkullBlockEntity.loadProperties(
                        gameProfile, gameProfilex -> nbttagcompound.put("SkullOwner", NbtHelper.writeGameProfile(new NbtCompound(), gameProfilex))
                     );
                  }
               }
            }
            ...
            if (icon == this.textureAtlas.getMissingImage()) {
               ...
               ModelPartWithResourceLocation[] headBits = new ModelPartWithResourceLocation[]{
                  new ModelPartWithResourceLocation(inner, resourceLocation), new ModelPartWithResourceLocation(outer, resourceLocation)
               };
   ...
   private Sprite createUnknownArmorIcons(Contact contact, ItemStack stack, Item helmet) {
      ...
      if (modelBiped != null && resourceLocation != null) {
         ModelPartWithResourceLocation[] headBitsWithResourceLocation = new ModelPartWithResourceLocation[]{
            new ModelPartWithResourceLocation(modelBiped.head, resourceLocation),
            new ModelPartWithResourceLocation(modelBiped.hat, resourceLocation)
         };
         ...
         armorImage = ImageUtils.fillOutline(
            ImageUtils.pad(ImageUtils.trimCentered(armorImage)), this.options.outlines, true, intendedWidth * 4.0F, intendedHeight * 4.0F, 2
         );
      ...
      if (icon == null && resourceLocation != null) {
         ...
         if (armorTexture != null) {
            if (!isPiglin) {
               ...
               BufferedImage armorImage = ImageUtils.fillOutline(
                  ImageUtils.pad(ImageUtils.scaleImage(armorTexture, 4.0F / scale * 47.0F / 38.0F)), this.options.outlines, true, 37.6F, 37.6F, 2
               );
               ...
               float scale = (float)armorTexture.getWidth() / 8.0F;
               BufferedImage armorImage = ImageUtils.fillOutline(
                  ImageUtils.pad(ImageUtils.scaleImage(armorTexture, 4.0F / scale * 47.0F / 38.0F)), this.options.outlines, true, 47.0F, 37.6F, 2
               );
         ...
         if (inRange) {
            try {
               ...
               if (this.options.filtering) {
                  ...
                  if (this.options.filtering) {
                     ...
                     matrixStack.translate(
                        (double)Math.round(-wayX * (double)this.layoutVariables.scScale) / (double)this.layoutVariables.scScale,
                        (double)Math.round(-wayZ * (double)this.layoutVariables.scScale) / (double)this.layoutVariables.scScale,
                        0.0
                     );
                  }
               }
               ...
               if (contact.name != null
                  && (this.options.showPlayerNames && contact.type == EnumMobs.PLAYER || this.options.showMobNames && contact.type != EnumMobs.PLAYER)) {
