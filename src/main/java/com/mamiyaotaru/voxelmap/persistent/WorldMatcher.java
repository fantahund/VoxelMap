         ...
         public void run() {
            ...
            if (!WorldMatcher.this.cancelled && this.candidateRegions.size() == 1 && !WorldMatcher.this.master.getWaypointManager().receivedAutoSubworldName()
               )
             {
               ...
               StringBuilder successBuilder = (new StringBuilder(I18nUtils.getString("worldmap.multiworld.foundworld1")))
                  .append(":")
                  .append(" ")
                  .append(((ComparisonCachedRegion)this.candidateRegions.get(0)).getSubworldName())
                  .append(".")
                  .append(" ")
                  .append(I18nUtils.getString("worldmap.multiworld.foundworld2"));
               ...
               MessageUtils.printDebug("remaining regions: " + this.candidateRegions.size());
               StringBuilder failureBuilder = (new StringBuilder("§4VoxelMap§r"))
                  .append(":")
                  .append(" ")
                  .append(I18nUtils.getString("worldmap.multiworld.unknownsubworld"));
