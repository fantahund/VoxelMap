...
public class GuiMobs extends GuiScreenMinimap {
   ...
   public void init() {
      ...
      this.filter = new TextFieldWidget(
         this.getFontRenderer(), this.getWidth() / 2 - 153 + filterStringWidth + 5, this.getHeight() - 56, 305 - filterStringWidth - 5, 20, (Text)null
      );
      ...
      this.addDrawableChild(
         this.buttonEnable = new ButtonWidget(
            ...
            100,
            20,
            new TranslatableText("options.minimap.mobs.enable"),
            button -> this.setMobEnabled(this.selectedMobId, true)
         )
      );
      this.addDrawableChild(
         this.buttonDisable = new ButtonWidget(
            ...
            100,
            20,
            new TranslatableText("options.minimap.mobs.disable"),
            button -> this.setMobEnabled(this.selectedMobId, false)
         )
      );
      this.addDrawableChild(
         new ButtonWidget(
            this.getWidth() / 2 + 4 + 50,
            this.getHeight() - 28,
            100,
            20,
