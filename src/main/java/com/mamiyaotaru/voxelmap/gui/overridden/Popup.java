...
public class Popup {
      ...
      if (clicked) {
         for(int t = 0; t < this.entries.length; ++t) {
            if (this.entries[t].enabled) {
               boolean entryClicked = mouseX >= (double)this.x
                  && mouseX <= (double)(this.x + this.w)
                  && mouseY >= (double)(this.y + t * 20)
                  && mouseY <= (double)(this.y + (t + 1) * 20);
               if (entryClicked) {
   ...
   public void drawPopup(MatrixStack matrixStack, int mouseX, int mouseY) {
      ...
      vertexBuffer.vertex((double)this.x, (double)(this.y + this.h), 0.0)
         .texture((float)this.x / var6, (float)this.y / var6)
         .color(64, 64, 64, 255)
         .next();
      vertexBuffer.vertex((double)(this.x + this.w), (double)(this.y + this.h), 0.0)
         .texture((float)(this.x + this.w) / var6, (float)this.y / var6)
         .color(64, 64, 64, 255)
         .next();
      vertexBuffer.vertex((double)(this.x + this.w), (double)(this.y + 0), 0.0)
         .texture((float)(this.x + this.w) / var6, (float)(this.y + this.h) / var6)
         .color(64, 64, 64, 255)
         .next();
      vertexBuffer.vertex((double)this.x, (double)(this.y + 0), 0.0)
         .texture((float)this.x / var6, (float)(this.y + this.h) / var6)
         .color(64, 64, 64, 255)
         .next();
      tessellator.draw();
