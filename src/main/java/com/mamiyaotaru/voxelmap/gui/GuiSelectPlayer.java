...
public class GuiSelectPlayer extends GuiScreenMinimap implements BooleanConsumer {
   ...
   public void init() {
      ...
      this.message = new TextFieldWidget(
         this.getFontRenderer(), this.getWidth() / 2 - 153 + messageStringWidth + 5, 34, 305 - messageStringWidth - 5, 20, (Text)null
      );
      ...
      this.filter = new TextFieldWidget(
         this.getFontRenderer(), this.getWidth() / 2 - 153 + filterStringWidth + 5, this.getHeight() - 55, 305 - filterStringWidth - 5, 20, (Text)null
      );
