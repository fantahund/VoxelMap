   ...
   public void init() {
      ...
      for(int t = 0; t < relevantOptions.length; ++t) {
         ...
         GuiOptionButtonMinimap optionButton = new GuiOptionButtonMinimap(
            ...
            button -> this.optionClicked(button)
         );
      ...
      ButtonWidget radarOptionsButton = new ButtonWidget(
         this.getWidth() / 2 - 155,
         this.getHeight() / 6 + 120 - 6,
         150,
         20,
         new TranslatableText("options.minimap.radar"),
         button -> this.getMinecraft().setScreen(new GuiRadarOptions(this, this.master))
      );
      ...
      this.addDrawableChild(
         new ButtonWidget(
            ...
            150,
            20,
            new TranslatableText("options.minimap.detailsperformance"),
            button -> this.getMinecraft().setScreen(new GuiMinimapPerformance(this, this.master))
         )
      );
      this.addDrawableChild(
         new ButtonWidget(
            ...
            button -> this.getMinecraft().setScreen(new GuiMinimapControls(this, this.master))
         )
      );
      this.addDrawableChild(
         new ButtonWidget(
            ...
            150,
            20,
            new TranslatableText("options.minimap.worldmap"),
            button -> this.getMinecraft().setScreen(new GuiPersistentMapOptions(this, this.master))
         )
      );
      this.addDrawableChild(
         new ButtonWidget(
            this.getWidth() / 2 - 100, this.getHeight() / 6 + 168, 200, 20, new TranslatableText("gui.done"), button -> this.getMinecraft().setScreen(this.parent)
         )
      );
   }
