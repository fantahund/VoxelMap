...
public class GuiMinimapOptions extends GuiScreenMinimap {
    ...
    public void init() {
        ...
        ButtonWidget radarOptionsButton = new ButtonWidget(this.getWidth() / 2 - 155, this.getHeight() / 6 + 120 - 6, 150, 20, Text.translatable("options.minimap.radar"), button -> VoxelContants.getMinecraft().setScreen(new GuiRadarOptions(this, this.master)));
        ...
        this.addDrawableChild(new ButtonWidget(this.getWidth() / 2 + 5, this.getHeight() / 6 + 120 - 6, 150, 20, Text.translatable("options.minimap.detailsperformance"), button -> VoxelContants.getMinecraft().setScreen(new GuiMinimapPerformance(this, this.master))));
        this.addDrawableChild(new ButtonWidget(this.getWidth() / 2 - 155, this.getHeight() / 6 + 144 - 6, 150, 20, Text.translatable("options.controls"), button -> VoxelContants.getMinecraft().setScreen(new GuiMinimapControls(this, this.master))));
        this.addDrawableChild(new ButtonWidget(this.getWidth() / 2 + 5, this.getHeight() / 6 + 144 - 6, 150, 20, Text.translatable("options.minimap.worldmap"), button -> VoxelContants.getMinecraft().setScreen(new GuiPersistentMapOptions(this, this.master))));
        this.addDrawableChild(new ButtonWidget(this.getWidth() / 2 - 100, this.getHeight() / 6 + 168, 200, 20, Text.translatable("gui.done"), button -> VoxelContants.getMinecraft().setScreen(this.parent)));
    }
