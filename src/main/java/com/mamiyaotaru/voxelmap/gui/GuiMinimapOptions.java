...
public class GuiMinimapOptions extends GuiScreenMinimap {
    ...
    public void init() {
        ...
        ButtonWidget radarOptionsButton = new ButtonWidget(this.getWidth() / 2 - 155, this.getHeight() / 6 + 120 - 6, 150, 20, Text.translatable("options.minimap.radar"), button -> this.getMinecraft().setScreen(new GuiRadarOptions(this, this.master)));
        ...
        this.addDrawableChild(new ButtonWidget(this.getWidth() / 2 + 5, this.getHeight() / 6 + 120 - 6, 150, 20, Text.translatable("options.minimap.detailsperformance"), button -> this.getMinecraft().setScreen(new GuiMinimapPerformance(this, this.master))));
        this.addDrawableChild(new ButtonWidget(this.getWidth() / 2 - 155, this.getHeight() / 6 + 144 - 6, 150, 20, Text.translatable("options.controls"), button -> this.getMinecraft().setScreen(new GuiMinimapControls(this, this.master))));
        this.addDrawableChild(new ButtonWidget(this.getWidth() / 2 + 5, this.getHeight() / 6 + 144 - 6, 150, 20, Text.translatable("options.minimap.worldmap"), button -> this.getMinecraft().setScreen(new GuiPersistentMapOptions(this, this.master))));
