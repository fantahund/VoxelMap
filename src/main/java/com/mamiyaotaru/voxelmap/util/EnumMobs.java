...
public enum EnumMobs {
   GENERICHOSTILE((Class)null, "Monster", false, 8.0F, "textures/entity/zombie/zombie.png", "", true, false),
   GENERICNEUTRAL((Class)null, "Mob", false, 8.0F, "textures/entity/pig/pig.png", "", false, true),
   GENERICTAME((Class)null, "Unknown_Tame", false, 8.0F, "textures/entity/wolf/wolf.png", "", false, true),
   ...
   PUFFERFISHHALF((Class)null, "Pufferfish_Half", false, 5.0F, "textures/entity/fish/pufferfish.png", "", false, true),
   PUFFERFISHFULL((Class)null, "Pufferfish_Full", false, 8.0F, "textures/entity/fish/pufferfish.png", "", false, true),
   ...
   TROPICALFISHA(
      TropicalFishEntity.class, "Tropical_Fish", true, 5.0F, "textures/entity/fish/tropical_a.png", "textures/entity/fish/tropical_a_pattern_1.png", false, true
   ),
   TROPICALFISHB(
      (Class)null, "Tropical_Fish", false, 6.0F, "textures/entity/fish/tropical_b.png", "textures/entity/fish/tropical_b_pattern_4.png", false, true
   ),
   ...
   VEXCHARGING((Class)null, "Vex", false, 0.0F, "textures/entity/illager/vex_charging.png", "", true, false),
   ...
   WITHERINVULNERABLE((Class)null, "Wither", false, 24.0F, "textures/entity/wither/wither_invulnerable.png", "", true, false),
   ...
   UNKNOWN((Class)null, "Unknown", false, 8.0F, "/mob/uknown.png", "", true, true);
   ...
   private static EnumMobs getMobTypeByClass(Class clazz) {
      if (OtherClientPlayerEntity.class.isAssignableFrom(clazz)) {
         return PLAYER;
      } else if (!clazz.equals(HorseEntity.class)
         && !clazz.equals(DonkeyEntity.class)
         && !clazz.equals(MuleEntity.class)
         && !clazz.equals(SkeletonHorseEntity.class)
         && !clazz.equals(ZombieHorseEntity.class)) {
         for(EnumMobs enumMob : values()) {
   ...
   private EnumMobs(
      Class clazz, String name, boolean topLevelUnit, float expectedWidth, String path, String secondaryPath, boolean isHostile, boolean isNeutral
   ) {
      this.clazz = clazz;
      this.id = name;
