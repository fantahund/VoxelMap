...
public enum EnumMobs {
    ...
    ARMADILLO(ArmadilloEntity.class, "Armadillo", true, 0.0F, "textures/entity/armadillo/armadillo.png", "", false, true),
    ...
    EnumMobs(Class<? extends Entity> clazz, String name, boolean topLevelUnit, float expectedWidth, String path, String secondaryPath, boolean isHostile, boolean isNeutral) {
        ...
        this.resourceLocation = Identifier.of(path.toLowerCase());
        this.secondaryResourceLocation = secondaryPath.isEmpty() ? null : Identifier.of(secondaryPath.toLowerCase());
