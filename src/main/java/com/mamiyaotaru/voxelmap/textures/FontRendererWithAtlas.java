...
public class FontRendererWithAtlas extends TextRenderer implements ResourceReloader {
   ...
   public FontRendererWithAtlas(TextureManager renderEngine, Identifier locationFontTexture) {
      super(
         identifierx -> (FontStorage)Util.make(
               new FontStorage(renderEngine, locationFontTexture), fontStorage -> fontStorage.setFonts(Lists.newArrayList(new Font[]{new BlankFont()}))
            )
      );
   ...
   private float renderDefaultChar(int charIndex, boolean shadow) {
      ...
      this.vertexBuffer
         .vertex((double)(this.posX + shadowOffset), (double)this.posY, 0.0)
         .texture(charXPosInSheet / sheetWidth, charYPosInSheet / sheetHeight)
         .color(this.red, this.blue, this.green, this.alpha)
         .next();
      this.vertexBuffer
         .vertex((double)(this.posX - shadowOffset), (double)(this.posY + 7.99F), 0.0)
         .texture(charXPosInSheet / sheetWidth, (charYPosInSheet + 7.99F * fontScaleY) / sheetHeight)
         .color(this.red, this.blue, this.green, this.alpha)
         .next();
      this.vertexBuffer
         .vertex((double)(this.posX + charWidth - 1.0F - shadowOffset), (double)(this.posY + 7.99F), 0.0)
         .texture((charXPosInSheet + (charWidth - 1.0F) * fontScaleX) / sheetWidth, (charYPosInSheet + 7.99F * fontScaleY) / sheetHeight)
         .color(this.red, this.blue, this.green, this.alpha)
         .next();
      this.vertexBuffer
         .vertex((double)(this.posX + charWidth - 1.0F + shadowOffset), (double)this.posY, 0.0)
         .texture((charXPosInSheet + (charWidth - 1.0F) * fontScaleX) / sheetWidth, charYPosInSheet / sheetHeight)
         .color(this.red, this.blue, this.green, this.alpha)
         .next();
         ...
         if (character == 167 && textIndex + 1 < text.length()) {
            ...
            if (charIndex != -1) {
               ...
               if (this.strikethroughStyle) {
                  this.vertexBuffer
                     .vertex((double)this.posX, (double)(this.posY + (float)(this.FONT_HEIGHT / 2)), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
                  this.vertexBuffer
                     .vertex((double)(this.posX + widthOfRenderedChar), (double)(this.posY + (float)(this.FONT_HEIGHT / 2)), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
                  this.vertexBuffer
                     .vertex((double)(this.posX + widthOfRenderedChar), (double)(this.posY + (float)(this.FONT_HEIGHT / 2) - 1.0F), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
                  this.vertexBuffer
                     .vertex((double)this.posX, (double)(this.posY + (float)(this.FONT_HEIGHT / 2) - 1.0F), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
               }
               ...
               if (this.underlineStyle) {
                  ...
                  this.vertexBuffer
                     .vertex((double)(this.posX + (float)l), (double)(this.posY + (float)this.FONT_HEIGHT), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
                  this.vertexBuffer
                     .vertex((double)(this.posX + widthOfRenderedChar), (double)(this.posY + (float)this.FONT_HEIGHT), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
                  this.vertexBuffer
                     .vertex((double)(this.posX + widthOfRenderedChar), (double)(this.posY + (float)this.FONT_HEIGHT - 1.0F), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
                  this.vertexBuffer
                     .vertex((double)(this.posX + (float)l), (double)(this.posY + (float)this.FONT_HEIGHT - 1.0F), 0.0)
                     .texture(u, v)
                     .color(this.red, this.blue, this.green, this.alpha)
                     .next();
               }
